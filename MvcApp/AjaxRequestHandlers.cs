    ...
    static internal class AjaxRequestHandlers
    {
        ...
        public class AjaxHandler : IAjaxRequestHandler
        {
            ...
            public AjaxRequestResult Process(AjaxRequest Request)
            {
                ...
                {
                    if (Sys.IsSameText(Request.OperationName, "AjaxRequest_OperationName"))
                        return AjaxRequest_OperationName(Request);

                    if (Sys.IsSameText(Request.OperationName, "AjaxRequest_Model"))
        ...
        static AjaxViewInfo GetViewInfo(AjaxRequest Request)
        {
            ...
            if (Sys.IsSameText(Request.OperationName, "AjaxDemoView"))
            {
