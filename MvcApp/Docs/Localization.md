...
This template application uses a different approach.
...
Create a **static** class to serve as the registry of the resource providers and as the central point of the whole resource system.
...
The application also provides base controller classes containing the exact same `L()` method.
