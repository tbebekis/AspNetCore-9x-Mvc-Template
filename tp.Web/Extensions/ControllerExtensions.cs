namespace tp.Web
{
    ...
    static public class ControllerExtensions
    {
        ...
        {
            IRazorViewEngine ViewEngine = WLib.GetService<IRazorViewEngine>();
            ...
            else
            {
                ...
                TempData = new TempDataDictionary(ActionContext.HttpContext, WLib.GetService<ITempDataProvider>());
            }
            ...
            if (ViewResult.View == null)
            {
                ...
                if (ViewResult.View == null)
                    throw new ApplicationException($"Cannot render a View to string. View not found: {ViewName}");
            }
