namespace tp.Logging
{
    ...
    /// <summary>
    /// Represents a named source in the log system.
    /// <para>The <see cref="LogEntry.Source"/> and the  <see cref="LogEntry.ScopeId"/> of a <see cref="LogEntry"/> are just names devised by the developer.</para>
    ...
    /// <para>A ScopeId could be the name of a method or the name of a group of methods, or whatever.</para>
    /// <para>The <see cref="Logger"/> class provides a method to create a Source.</para>
    ...
    /// <para>Any call to <see cref="LogSource"/> log methods, such as <c> Log()</c>,  <c> Debug()</c>,  <c>Error()</c>, etc. 
    /// produces a <see cref="LogEntry"/> marked with the Source name and the name of the latest Scope.</para>
    /// </summary>
    public class LogSource
    {
        ...
        // ● private  
        readonly System.Threading.Lock syncLock = new();
        int fActive = 0;
